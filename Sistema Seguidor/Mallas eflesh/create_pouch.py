...
if __name__ == "__main__":
    ...
    input_path = "/home/cidis-eflesh/Documents/eFlesh_STL/prot_8C_0.006231323/Test_0.006231323_Centered.obj" #Path to obj file FALSE that was created.
    output_path = "/home/cidis-eflesh/Documents/eFlesh_STL/prot_8C_0.006231323/Test_0.006231323_Centered_blender.obj" #Path to waveform for blender to open
    # Lists of magnets to use
    list_of_magnets = [
        [8, 2, [-3, 0, 3.35]]#, # [diameter, thickness, [centerX, centerY, centerZ]]
        #[9, 4, [30, 0, 5]] #if more than one magnet
    ]
